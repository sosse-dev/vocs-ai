...
<MetaTags
	title="VOCS AI – Asisten Belajar Bahasa Inggris"
	description="VOCS adalah asisten AI interaktif untuk membantu kamu belajar Bahasa Inggris. Dapatkan bantuan grammar, kosakata, dan latihan percakapan dengan mudah."
	titleTemplate="%s | VOCS AI"
	openGraph={{
		title: 'VOCS AI – Asisten Bahasa Inggris ↔ Indonesia',
		description:
			'Belajar, menerjemahkan, dan latihan bahasa Inggris dengan AI. Dukungan grammar, vocabulary, percakapan, dan latihan kosakata level pemula hingga mahir.',
		url: 'https://vocs.id', // ganti dengan URL kamu
		type: 'website',
		images: []
	}}
	twitter={{
		site: '@vocs_ai', // ganti kalau punya Twitter
		title: 'VOCS AI – Asisten Bahasa Inggris ↔ Indonesia',
		description:
			'AI interaktif untuk belajar bahasa Inggris dan menerjemahkan ke Indonesia. Cocok buat pemula maupun lanjutan.',
		image: 'https://vocs.id/og-image.jpg'
	}}
/>

<div class="flex flex-col h-screen bg-gray-900 text-white">
	<!-- Header -->
	<header class="p-4 border-b border-gray-800 shadow-sm">
		<div class="max-w-3xl mx-auto flex items-center justify-between">
			...
			<a href="/en" class="text-xs text-blue-400 hover:underline">EN</a>
		</div>
	</header>
		...
		<div class="max-w-3xl mx-auto space-y-4">
			...
			{:else}
				...
				<div class="flex flex-col items-center justify-center h-full text-center space-y-6 pt-16">
					<h2 class="text-2xl font-bold">Apa yang ingin kamu pelajari hari ini?</h2>
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md">
						<button
							aria-label="button"
							on:click={() => startChatWithPrompt("Apa perbedaan 'say' dan 'tell'?")}
						...
						<button
							aria-label="button"
							on:click={() => startChatWithPrompt("Apa arti dari kata 'exacerbate'?")}
						...
						<button
							aria-label="button"
							on:click={() => startChatWithPrompt('Bisa bantu perbaiki grammar kalimat ini?')}
						...
						<button
							aria-label="button"
							on:click={() =>
								startChatWithPrompt('Berikan latihan vocabulary untuk level intermediate.')}
	...
	{#if showFooter}
		...
		>
			Ditenagai oleh <span class="font-semibold text-gray-300">DeepSeek V3</span> via
			<span class="font-semibold text-gray-300">OpenRouter</span>. Pesan
			<span class="italic">tidak disimpan</span>. AI ini mungkin sesekali memberikan
			<span class="text-yellow-400 font-medium">informasi yang tidak akurat</span>, harap verifikasi
			fakta bila perlu.
			<button
